"""
Auto-generated strongly typed processor base class for DIV.
...
@dataclass
class DIVInputData:
    from_plasma: List[float] = field(default_factory=list)
...
class DIVProcessorBase(AbstractTrackProcessor):
